...
import obtenerValTiempos from "../api/obtener_val_tiempos";
import { Alert, FormControl, InputGroup, Table } from "react-bootstrap";
import { read, utils } from "xlsx";
import Papa from "papaparse";
import { Spreadsheet } from "react-spreadsheet";
import "../estilos/all.css"
import guardarTiempos from "../api/guardar_tiempos";
import Notificador from "./notificador";
import Graficador from "./graficador";
import obtenerResTiempos from "../api/obtener_res_tiempos";
...
export default function Contenido_eficiencia({ idSof }) {
        ...
        if (idSof != null) {
            const obtenerData = async () => {
                try {
                    ...
                    const data = await obtenerValTiempos(idSof);
                    ...
                    <div className="tab-content" id="cardTabContent">
                        ...
                        >
                            <div className="row justify-content-center">
                                <div className="col-xxl-6 col-xl-8">
                                    <h3 className="text-primary">Tiempos por usuarios</h3>
                                    <h5 className="card-title mb-5">
                                        Ingrese o edite los tiempos que duró cada usuario en realizar cada tarea.
                                    </h5>
                                    ...
                                    <h5 className="text small">Cree una nueva tabla de tiempos por usuarios </h5>
                                    ...
                                    <div className="d-flex form-group flex-column flex-sm-row">
                                        ...
                                        <InputGroup>
                                            ...
                                            {/* <Button variant="secondary" type="button"
                                                ...
                                                href="/plantillas/tiempos.xlsx" download="tiempos"
                                    ...
                                    {tablaAux.length > 0 ?
                                        <h5 className="small text-center">La fila
                                            <b>&nbsp;REF&nbsp;</b>
                                            corresponde a la duración estándar.
                                            <br />
                                            Trabaje en armonía con las unidades que prefiera: min, seg...
                                            <br />
                                        </h5>
                                        :
                                        ""}
                        ...
                        >
                            {tabla.length > 0 && (
                                <div className="row justify-content-center">
                                    <div className="col-xxl-6 col-xl-8">
                                        <h3 className="text-primary">Porcentajes de eficiencia</h3>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="card shadow mb-4">
                                                    ...
                                                    <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                        <h6 className="m-0 font-weight-bold text-primary">Eficiencia por usuarios</h6>
                                                    </div>
                                                        ...
                                                        <div className="chart-area">
                                                            <div className="chartjs-size-monitor">
                                                                ...
                                                                <div className="chartjs-size-monitor-shrink">
                                                                    <div className="" />
                                                                    <Graficador
                                                                        dataGrafica={formatDataGraficaEficiencia(dataGraf)}
                                                                        variablex={"Usuario"}
                                                                        variabley={"Eficiencia"}
                                                                        color={"fill"}
                                            ...
                                            <div className="col-xl-6 col-lg-6">
                                                <div className="card shadow mb-4">
                                                    {/* Card Header */}
                                                    <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                        <h6 className="m-0 font-weight-bold text-primary">Eficiencia por tareas</h6>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-12 col-lg-12">
                                                <div className="card shadow mb-4">
                                                    ...
                                                    {/* Card Body */}
                                                    <div className="card-body">
                                                        <h3> <b> La eficiencia total obtenida es de un {promedio}%</b></h3>
                                                        <p></p>
                                                        <p>El usuario con mayor eficiencia es el <b>Usuario {userMaxIndex + 1}</b> con un {userMax}%</p>
                                                        <p>El usuario con menor eficiencia es el <b>Usuario {userMinIndex + 1}</b> con un {userMin}%</p>
                                                        <p>La tarea en que se obtuvo más eficiencia es la <b>Tarea {tareaMaxIndex + 1}</b> con un {tareaMax}%</p>
                                                        <p>La tarea en que se obtuvo menos eficiencia es la <b>Tarea {tareaMinIndex + 1}</b> con un {tareaMin}%</p>
                                                    </div>
...
const formatDataGraficaEficiencia = (dat) => {
    const dataGrafica = dat.map((eficiencia, index) => {
        return {
...
const formatDataGraficaTareas = (dat) => {
    ...
    for (let i = 0; i < firstArray.length; i++) {
        let suma = parseInt(0);
        let proceso = parseInt(0);
        for (let j = 1; j < dat.length; j++) {
            proceso = (firstArray[i])/parseInt(dat[j][i])
            suma = suma + proceso;            
        }
        const average = (suma / (dat.length - 1)) * 100;
    ...
    const dataGrafica = averages.map((eficiencia, index) => {
        return {
            Tarea: `Tarea ${index + 1}`,
            Eficiencia: eficiencia,
            fill: getColor(dat)
